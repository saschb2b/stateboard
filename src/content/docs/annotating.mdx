...
- **Click an existing region** to select it, then edit its state, label, or notes — or delete it.
- **Drag the box** to move it, or **pull a corner** to resize it. Arrow keys nudge the selected region; hold **Shift** to resize from the keyboard.
