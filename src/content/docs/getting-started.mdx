...
Click **Share** in the header to copy the read-only URL. The arrow beside it opens a menu with **Open share view** (the public page in a new tab) and **Manage links** (mint extra links or revoke one).
