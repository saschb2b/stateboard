...
The current stage is **v1 (team-ready)**, released as `2026.8.0`. **Do not implement features from a later milestone unless explicitly asked.** If the user requests something that smells like a v2+ feature, confirm before building and cite the milestone it belongs to.
